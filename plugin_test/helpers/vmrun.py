...
class Vmrun(object):
    """Vmrun utility wrapper."""

    def __init__(self, host_type, path_to_vmx_file,
                 host_port=None, host_name=None,
                 username=None, password=None,
                 guest_password=None, guest_username=None):
        """Create Vmrun object."""
    ...
    def start(self):
        """Power action: start the virtual machine on ESXI host."""
        self.__execute('start')

    def stop(self):
        """Power action: stop the virtual machine on ESXI host."""
        self.__execute('stop')

    def reset(self):
        """Power action: reset the virtual machine on ESXI host."""
