...
class TestNSXtFailover(TestNSXtBase):
    ...
    def nsxt_uninstall_negative(self):
        """Check that it is impossible to remove plugin while at least one
        environment exists.
    ...
    def nsxt_shutdown_controller(self):
        ...
        Scenario:
          1. Log in to the Fuel with preinstalled plugin and deployed
             environment with 3 controllers.
          2. Log in to Horizon.
          ...
          6. Ensure that there is a connectivity to outside world from created
             VM.
        ...
        external = {ip: ['8.8.8.8'] for ip in ips}
        os_help.check_connection_through_host(access_point_ip, external)
        ...
        ip_pairs = {key: ips_1 for key in external}
    ...
    def nsxt_reboot_vcenter(self):
        ...
        Scenario:
            1. Log in to the Fuel with deployed environment with plugin.
            2. Log in to Horizon.
