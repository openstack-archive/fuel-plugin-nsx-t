...
class TestNSXtScale(TestNSXtBase):
    ...
    def nsxt_add_delete_controller(self):
        """Check that system functionality doesn't fail when controller
    ...
    def nsxt_add_delete_compute_node(self):
        """Verify that system functionality doesn't fail when compute node
        has been removed or added.
    ...
    def nsxt_add_delete_compute_vmware_node(self):
        """Verify that system functionality doesn't fail when compute-vmware
        node has been removed or added.
