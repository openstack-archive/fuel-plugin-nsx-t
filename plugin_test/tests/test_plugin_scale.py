...
class TestNSXtScale(TestNSXtBase):
    ...
    def nsxt_add_delete_controller(self):
        ...
        Scenario:
            ...
            6. Configure VMware vCenter Settings. Add 2 vSphere clusters and
            configure Nova Compute instances on controllers and compute-vmware.
            7. Deploy cluster.
            8. Run OSTF.
            9. Launch 1 vcenter instance with m1.tiny flavor and 1 nova
               instance.
        ...
        self.show_step(6)
        target_node2 = self.fuel_web.get_nailgun_node_by_name('slave-06')
        ...
        # # Launch 1 vcenter instance with m1.tiny flavor and 1 nova instance
        self.show_step(9)
        ...
        os_help.create_instance(os_conn, az='vcenter', flavor='m1.tiny')

        self.show_step(10)  # Remove node with controller role
        self.fuel_web.update_nodes(cluster_id,
                                   {'slave-02': ['controller']},
                                   False, True)
        ...
        self.show_step(14)  # Add controller
    ...
    def nsxt_add_delete_compute_node(self):
        ...
        self.show_step(8)  # Launch nova vm
        os_conn = os_actions.OpenStackActions(
            self.fuel_web.get_public_vip(cluster_id),
            SERVTEST_USERNAME,
            SERVTEST_PASSWORD,
    ...
    def nsxt_add_delete_compute_vmware_node(self):
        ...
        Scenario:
            ...
            7. Deploy cluster.
            8. Run OSTF.
            9. Launch vcenter vm with m1.tiny flavor.
            10. Remove node with compute-vmware role.
            11. Reconfigure vcenter compute clusters.
            12. Redeploy cluster.
            13. Check that instance has been removed.
            14. Run OSTF.
            15. Add node with compute-vmware role.
        ...
        self.fuel_web.vcenter_configure(cluster_id,
                                        target_node_1=target_node['hostname'])
        ...
        self.show_step(9)  # Launch vcenter vm with m1.tiny flavor
        os_conn = os_actions.OpenStackActions(
            self.fuel_web.get_public_vip(cluster_id),
            SERVTEST_USERNAME,
            SERVTEST_PASSWORD,
        ...
        self.show_step(10)  # Remove node with compute-vmware role
        self.fuel_web.update_nodes(cluster_id,
                                   {'slave-04': ['compute-vmware']},
                                   False, True)
        ...
        self.show_step(15)  # Add node with compute-vmware role
        self.fuel_web.update_nodes(cluster_id,
