...
class TestNSXtSystem(TestNSXtBase):
    ...
    def nsxt_public_network_availability(self):
        ...
        self.show_step(4)
        vm1_fip, vm2_fip = os_help.create_and_assign_floating_ips(os_conn,
                                                                  [vm1, vm2])
    ...
    def nsxt_connectivity_diff_networks(self):
        ...
        subnet1 = os_conn.create_subnet(
            ...
            allocation_pools=[{'start': '192.168.101.2',
                               'end': '192.168.101.254'}],
            ip_version=4,
            gateway_ip=None)
        ...
        subnet2 = os_conn.create_subnet(
            ...
            allocation_pools=[{'start': '192.168.102.2',
                               'end': '192.168.102.254'}],
            ip_version=4,
            gateway_ip=None)
        ...
        self.show_step(7)
        os_conn.neutron.update_subnet(
            subnet1['id'], {'subnet': {'gateway_ip': '192.168.101.1'}})
        os_conn.add_router_interface(router_id=rout1['id'],
                                     subnet_id=subnet1['id'])

        os_conn.neutron.update_subnet(
            subnet2['id'], {'subnet': {'gateway_ip': '192.168.102.1'}})
        os_conn.add_router_interface(router_id=rout1['id'],
                                     subnet_id=subnet2['id'])
        ...
        os_conn.neutron.remove_interface_router(
            rout1['id'], {"router_id": rout1, "subnet_id": subnet2['id']})
        ...
        os_conn.neutron.remove_interface_router(
            rout1['id'], {"router_id": rout1['id'],
                          "subnet_id": subnet1['id']})
        os_conn.neutron.remove_interface_router(
            rout2['id'], {"router_id": rout2['id'],
                          "subnet_id": subnet2['id']})
