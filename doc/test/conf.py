# -*- coding: utf-8 -*-
#
# Fuel NSX plugin documentation build configuration file, created by
...
latex_documents = [
  ('index', 'nsx-test-plan-' + version + '.tex', u'Fuel NSX plugin testing documentation',
...
man_pages = [
    ('index', 'fuelnsxplugin', u'Fuel NSX plugin testing documentation',
     [u'Mirantis Inc.'], 1)
]
